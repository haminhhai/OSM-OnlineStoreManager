...
export const BD_INCOMPLETE_TEXT = "Hãy nhập phản hồi mà bạn muốn gửi cho quản lý!"
...
export const BD_WRONG_FAILED_USER_EXIST = "Tên đăng nhập đã tồn tại. Hãy thử tên đăng nhập khác nhé!"
export const BD_MESSAGE_FAILED_USER_NOT_EXIST = "Tài khoản không tồn tại! Xin vui lòng thử lại hoặc Đăng ký!"
export const BD_MESSAGE_FAILED_CHAR_PASSWORD = 'Mật khẩu của bạn phải có ít nhất 6 kí tự!'
...
export const BD_WRONG_TYPE_EMAIL = 'Địa chỉ email không hợp lệ'
